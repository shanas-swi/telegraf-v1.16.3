...
const deprecationMsg = "E! Error: this Riemann output plugin will be deprecated in a future release, see https://github.com/shanas-swi/telegraf-v1.16.3/issues/1878 for more details & discussion."
