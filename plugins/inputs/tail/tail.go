...
import (
	...
	"github.com/shanas-swi/telegraf-v1.16.3/internal/globpath"
	"github.com/shanas-swi/telegraf-v1.16.3/plugins/common/encoding"
...
const sampleConfig = `
  ...
  ## https://github.com/shanas-swi/telegraf-v1.16.3/blob/master/docs/DATA_FORMATS_INPUT.md
  data_format = "influx"
