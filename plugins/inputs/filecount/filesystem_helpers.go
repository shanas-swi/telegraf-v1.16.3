...
/*
	...
	will be the same regardless of the platform sitting underneath our tests (directory sizes vary see https://github.com/shanas-swi/telegraf-v1.16.3/issues/6011)
