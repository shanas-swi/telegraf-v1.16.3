...
import (
	...
	"github.com/shanas-swi/telegraf-v1.16.3/plugins/inputs/exec"
	"github.com/shanas-swi/telegraf-v1.16.3/plugins/inputs/http_listener_v2"
	"github.com/shanas-swi/telegraf-v1.16.3/plugins/inputs/memcached"
	"github.com/shanas-swi/telegraf-v1.16.3/plugins/inputs/procstat"
	"github.com/shanas-swi/telegraf-v1.16.3/plugins/outputs/azure_monitor"
	httpOut "github.com/shanas-swi/telegraf-v1.16.3/plugins/outputs/http"
